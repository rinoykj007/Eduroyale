      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            >
              <div className="relative w-full min-h-[300px] sm:min-h-[400px] md:min-h-[450px] lg:min-h-[500px]">
                <DotLottiePlayer />
              </div>
            </motion.div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {[
            ...
            },
            {
              ...
              description:
                "Strategic course selection aligned with your career goals.",
              icon: "📚",
            ...
            },
            {
              ...
              description:
                "Long-term career planning and growth opportunities.",
              icon: "🚀",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "Development of a personalized education and career roadmap",
                gradient: "from-emerald-50 to-teal-50",
              ...
              },
              {
                ...
                description:
                  "Continuous guidance throughout your academic journey",
                gradient: "from-orange-50 to-amber-50",
