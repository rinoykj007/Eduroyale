          ...
          {[
            {
              ...
              iconBg: "bg-white",
              hoverBg: "hover:shadow-lg hover:-translate-y-1",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Round-the-clock support for any emergencies or queries",
                bgColor: "bg-gradient-to-br from-emerald-50 to-emerald-100",
                textColor: "text-emerald-800",
              },
            ].map((item, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className={`${item.bgColor} rounded-xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 shadow-md`}
              >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <motion.div
              ...
              className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 shadow-md"
            >
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5 }}
              className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 shadow-md"
            >
