    ...
    <div className="bg-gradient-to-b from-[#F8F9FA] via-[#E9ECEF] to-[#DEE2E6] min-h-screen text-gray-800 font-['Outfit']">
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-16 mt-16 sm:mt-0 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 max-w-6xl mx-auto">
            <div className="md:w-1/2 text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#2B6CB0] via-[#3182CE] to-[#4299E1] leading-tight font-['Outfit'] tracking-tight">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-[#2B6CB0] via-[#3182CE] to-[#4299E1] font-['Outfit']">
        ...
        >
          <div className="bg-white shadow-lg rounded-xl p-8 md:p-12">
            <h2 className="text-3xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#2B6CB0] via-[#3182CE] to-[#4299E1] font-['Outfit']">
