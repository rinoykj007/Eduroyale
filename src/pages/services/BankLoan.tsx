  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-blue-50 min-h-screen text-gray-800 font-moderustic pt-16 md:pt-20">
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-16 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-900 via-blue-600 to-blue-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          {[
            ...
            <motion.div
              ...
              className="relative overflow-hidden bg-white rounded-2xl p-8 hover:shadow-xl transition-all duration-300 border border-blue-100/20 group hover:-translate-y-1"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
          {[
            ...
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-100/40 to-transparent rounded-full -mr-16 -mt-16 group-hover:scale-110 transition-all duration-300"></div>
              <div className="relative z-10">
                <div className="text-3xl font-bold bg-gradient-to-br from-blue-600 to-blue-400 rounded-2xl w-16 h-16 flex items-center justify-center text-white shadow-lg mb-6">
                  {process.step}
                </div>
                <h3 className="text-xl font-bold mb-3 text-gray-800 group-hover:text-blue-600 transition-colors duration-300">
                  {process.title}
